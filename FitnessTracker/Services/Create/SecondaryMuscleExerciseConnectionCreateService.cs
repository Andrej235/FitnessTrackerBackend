...
{
    public class SecondaryMuscleExerciseConnectionCreateService(DataContext context, IReadService<SecondaryMuscleGroupInExercise> readService) : CreateService<SecondaryMuscleGroupInExercise>(context)
    {
