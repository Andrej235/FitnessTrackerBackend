...
namespace FitnessTracker.Migrations
{
    ...
    [Migration("20241109213559_Add index for creatorid and name of splits and workouts")]
    partial class Addindexforcreatoridandnameofsplitsandworkouts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FitnessTracker.Models.SplitPin", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FitnessTracker.Models.UserSettings", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<bool>("PublicCompletedWorkouts")
                        .HasColumnType("bit");

                    b.Property<bool>("PublicCurrentSplit")
                        .HasColumnType("bit");

                    b.Property<bool>("PublicFavoriteSplits")
                        .HasColumnType("bit");

                    b.Property<bool>("PublicFavoriteWorkouts")
                        .HasColumnType("bit");

                    b.Property<bool>("PublicFollowing")
                        .HasColumnType("bit");

                    b.Property<bool>("PublicLikedSplits")
                        .HasColumnType("bit");

                    b.Property<bool>("PublicLikedWorkouts")
                        .HasColumnType("bit");

                    b.Property<bool>("PublicStreak")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("FitnessTracker.Models.WorkoutPin", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FitnessTracker.Models.UserSettings", b =>
                {
                    b.HasOne("FitnessTracker.Models.User", "User")
                        .WithOne("Settings")
                        .HasForeignKey("FitnessTracker.Models.UserSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FitnessTracker.Models.User", b =>
                {
                    ...
                    b.Navigation("SplitPins");

                    b.Navigation("WorkoutPins");
                });
